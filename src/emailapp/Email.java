...
public class Email {
    ...
    private String generate_password(int length){
        ...
        String Samll_cahrs = "abcdefghijklmnopqrstuvwxyz";
        String numbers = "0123456789";
        String symbols = "!@#$%&?";
        String values = Capital_chars + Samll_cahrs + numbers + symbols;
        String password = "";
    ...
    public void set_mailCap(){
        ...
        System.out.println("Enetr new mailbox capacity:");
    ...
    public void storefile(){
       try{
           FileWriter in = new FileWriter("C:\\Users\\Nikita patidar\\Desktop\\info.txt");
           in.write("First name:"+this.fname);
           in.append("\nLast name:"+this.lname);
           in.append("\nEmail:"+this.email);
           in.append("\nPassword:"+this.password);
           in.append("\nCapacity:"+this.mailCapacity);
           in.append("\nAlternante mail:"+this.alter_email);
           in.close();
    ...
    public void read_file(){
        try{
            FileReader f1 = new FileReader("C:\\Users\\Nikita patidar\\Desktop\\info.txt");
            int i;
            while((i= f1.read())!=1){
